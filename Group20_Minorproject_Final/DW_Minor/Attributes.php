...
<p style="text-align:center">Action Attribute</p>
...
<div style="text-align:center">
			<form>
				<label for="institute_name">Enter the attribute corresponding to action </label><br>
				<input type="text" id="att_name" name="attname_name"><br>
<button  class="button" type="submit" value="Save" name="add" style="margin-top:10px" >ADD</button>
			</form>
</div>
</div>
</body>
...
<?php 
if(isset($_GET["attname_name"]))
{
	$option=$_GET["attname_name"];
    if(!empty($option))
    {
        $sql="ALTER TABLE institute_attribute ADD $option varchar(40) AFTER alt_name;";
