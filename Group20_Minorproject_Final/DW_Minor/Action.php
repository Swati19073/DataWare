...
<div style="text-align:center">
			<form>
				<label for="txt_action">Enter the action associated with your decision: </label><br>
				<input type="text" id="txt_action" name="txt_action" style="margin-top:5px"><br>
<button class="button" type="submit" value="Save" name="act_save"   style="margin-top:5px" >Save</button>

            </form>
<form method="post" action="Attributes.php" style="margin-top:2px">
<br/>
<button  class="button" onclick="Attributes.php" >Next</button>
...
<?php 
if (isset($_GET["txt_action"]))
{
	$action=$_GET["txt_action"];
    
    if(!empty($action))
    {
	$sql="INSERT INTO action(name)VALUES('$action')";
