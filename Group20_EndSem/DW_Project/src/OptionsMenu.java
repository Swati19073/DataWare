...
//				
//				endSemQueries es=new endSemQueries(projectId);
////				boolean flag=es.createTables();
//				boolean flag=es.createDimensions();
//				
//				System.out.println(flag);
				endSemQueries es3= new endSemQueries (projectId);
				boolean flag=es3.createTables();
				System.out.println(flag);
				Output o=new Output(projectId);
				o.printOutput();
